...
function cart() {
  ...
  {/* Main Content */}
  <div className="grid  md:grid-cols-2 sm:grid-cols-1  gap-9  mt-[50px] px-4 md:px-8 lg:px-16">
    {/* Products List Section */}
    <div>
      {/* Header Bar */}
      <div
        className="md:w-[700px] hidden sm:flex justify-between items-center p-4 border-b border-gray-300"
    ...
    {/* Cart Totals Section */}
    <div
      className=" md:w-[400px] p-4 rounded-lg shadow-md md:ml-[150px]"
      style={{ backgroundColor: "rgba(255, 249, 229, 1)" }}
    >
      {/* Heading */}
      ...
      {/* Checkout Button */}
      <button className="my-9 w-full h-[59px] text-black text-xl sm:text-2xl font-normal border border-black py-2 rounded-2xl hover:bg-black hover:text-white transition duration-200">
        Checkout
      </button>
    </div>
  </div>
