...
const DeliveryInformation= () =>{
  return (
    <div className="flex  items-center font-poppins bg-[rgba(250,244,244,1)] md:h-[300px] md:py-11 md:mt-[200px]" >
        <div className=" text-left grid md:grid-cols-3   gap-6 w-full mt-8">
        {/* Box 1 */}
